...
namespace Filmsystemet4.Controllers
{
    public class GenresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GenreID,Title,Description,Name")] Genre genre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GenreID,Title,Description,Name")] Genre genre)
        {
            if (id != genre.GenreID)
            {
                return NotFound();
